...
Hvor $V$ er en vektor, som indeholder antallet af noder for de givet grafer.

$$k_{baseline_2}(V_1, V_2) = \sum\limits_{v_1 \in V_1}{\sum\limits_{v_2 \in V_2}{k_{gauss}(v_1, v_2, \sigma)}}$$
