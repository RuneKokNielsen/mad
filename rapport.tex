...
\label{eq:d_1}
\end{align}
Bemærk at venstre side af (\ref{eq:d_1}) er prikproduktet mellem to euklidiske vektorer. Vi kan da udnytte at $A\cdot B = ||A||\times||B||\times\cos\theta$, hvor $A$ og $B$ er euklidiske vektorer, og $\theta$ er vinklen mellem dem:
\begin{equation}
...
\begin{thebibliography}{9}
	...
	\bibitem{kernel-induced-feature-spaces}
