...
Denne transformation er et \textit{all pairs shortest path} problem, som kan løses med flere algoritmer. \cite{shortest-path} foreslår Floyd-transformation ved hjælp af Floyd-Warshall algoritmen.
