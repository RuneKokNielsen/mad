...
For at opnaa den stoerste afstand mellem de to margner, skal formlen nedenfor maximeres (modsat af formlen for at finde $d$).  \\
$$f(w)=\frac{||w||^2}{2}$$

(Optimering)

$$L_P = \frac{1}{2} * ||w||^2 - \sum\limits_{i=1}^N \lambda_i (y_i(w * x_i + b) - 1)$$
